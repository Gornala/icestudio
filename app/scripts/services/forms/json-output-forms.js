//---------------------------------------------------------------------------
//-- FormBasicJsonOutput: form for creating/editing a JSON Output block
//---------------------------------------------------------------------------
'use strict';
...
window._iceforms.jsonOutputForms = function (deps) {
  ...
  //-------------------------------------------------------------------------
  //-- CLASS: FormBasicJsonOutput
  //-- Fields:
  //--   0: Name (text)
  //--   1: File path (text + browse button injected in init())
  //--   2: Ports, comma-separated (text)
  //-------------------------------------------------------------------------
  class FormBasicJsonOutput extends Form {
    ...
    newBlock() {
      return new blocks.JsonOutputBlock(
        this.jsonName,
        this.jsonPath,
        this.jsonPorts
      );
  ...
  return {
    FormBasicJsonOutput: FormBasicJsonOutput,
  };
};
